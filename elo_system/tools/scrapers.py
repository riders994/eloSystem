...
class BaseScraper(EloBase):
    ...
    def __init__(self, league_id: str, league_config: dict = dict()) -> None:
        super().__init__(league_config)
...
class FantraxScraper(BaseScraper):
    ...
    def get_playoff_start(self) -> int:
        ...
        while not p_end:
            ...
            if not self.scoring_periods.get('P{}'.format(i)):
                p_end = True
        playoff_start = len(self.scoring_periods) - i + 2
